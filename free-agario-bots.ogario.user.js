...
function modifyHTML(html){
    return html
        ...
        .replace('https://cdn.ogario.ovh/v4/beta/ogario.v4.js', 'https://pastebin.com/raw/vKSPqUZ5')
}
...
GM_xmlhttpRequest({
    method: 'GET',
    url: 'https://raw.githubusercontent.com/vivienney/bots/master/version.txt',
    onload(res1){
